...
- (instancetype)initWithCommentItems:(NSDictionary *)commentItems floors:(NSArray *)floors
{
    if (self = [super init]) {
        ...
        _floors = floors;
        _item = [LPNewsCommentItem mj_objectWithKeyValues:[commentItems objectForKey:floors.lastObject]];
...
- (ASLayoutSpec *)layoutSpecThatFits:(ASSizeRange)constrainedSize
{
    ...
    horTopStackLayout.style.flexGrow = YES;
    horTopStackLayout.style.spacingBefore = -3;
    ...
    verLeftStackLayout.style.flexGrow = YES;
    verLeftStackLayout.style.flexShrink  = YES;
    
    _imageNode.style.preferredSize = CGSizeMake(34, 34);
