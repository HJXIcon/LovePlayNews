...
//    LPNewsPagerController *newsPagerController = [[LPNewsPagerController alloc]init];
    ...
    [self addChildViewController:[[UIViewController alloc]init] title:@"资讯" image:@"icon_zx_nomal_pgall" selectedImage:@"icon_zx_pressed_pgall" imageInsets:imageInsets titlePosition:titlePosition navControllerClass:[LPNavigationController class]];
}
...
//    LPRecommendController *recommendController = [[LPRecommendController alloc]init];
    [self addChildViewController:[[UIViewController alloc]init] title:@"精选" image:@"icon_jx_nomal_pgall" selectedImage:@"icon_jx_pressed_pgall"imageInsets:imageInsets titlePosition:titlePosition navControllerClass:[LPNavigationController class]];
}
...
//    LPZonePagerController *zoneController = [[LPZonePagerController alloc]init];
    [self addChildViewController:[[UIViewController alloc]init] title:@"社区" image:@"icon_sq_nomal_pgall" selectedImage:@"icon_sq_pressed_pgall"imageInsets:imageInsets titlePosition:titlePosition navControllerClass:[LPNavigationController class]];
}
...
//    LPMineViewController *mineController = [[LPMineViewController alloc]init];
    [self addChildViewController:[[UIViewController alloc]init] title:@"我" image:@"icon_w_nomal_pgall" selectedImage:@"icon_w_pressed_pgall"imageInsets:imageInsets titlePosition:titlePosition navControllerClass:[LPNavigationController class]];
}
